...
print("vlua blocking call error, veh was nil. vehid: " .. vehid)
end
end
...
if veh then veh:queueLuaCommand(cmd) else print("vlua blocking call error, veh was nil. vehid: " .. vehid) end
end
